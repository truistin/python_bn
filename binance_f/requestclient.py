...
class RequestClient(object):
    ...
    def get_priceIndex(self,symbol)->any:
        response = call_sync(self.request_impl.priceIndex(symbol))
        return response[0]
    
    def get_crossMarginCollateralRatio(self)->any:
        response = call_sync(self.request_impl.crossMarginCollateralRatio())
        return response[0]
