...
class symbolInfo:
    ...
    def time_calc(self):
        ...
        logger.info("time_calc symbol : {}, value symbol : {}, key mean : {}, value mean : {}, mean thresh : {}, std thresh : {}, value index data : {}, value lastindex data : {}, data size : {}, mean_thresh_std : {}, time : {}"
            .format(self.symbol, value.symbol , key_mean, value_mean, mean_thresh, std_thresh, value.data[value.last_index_np], value.data[value.index_np], np.size(data), mean_thresh_std, utc_now, spread_std_array))  
